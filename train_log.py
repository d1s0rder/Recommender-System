...
def main(spark, model_file):
    ...
    train = train.withColumn('logcount', log('count'))
    ...
    als = ALS(rank =2, regParam = 10, alpha = 25, userCol = 'convert_user_id', \
              itemCol = 'convert_track_id', ratingCol = 'logcount', implicitPrefs = True)
